...
HomeIcon.propTypes = { width: PropTypes.number }
MinusCircleIcon.propTypes = { width: PropTypes.number }
PlusCircleIcon.propTypes = { width: PropTypes.number }
CartIcon.propTypes = { width: PropTypes.number }
TrashIcon.propTypes = { width: PropTypes.number }
GitHubIcon.propTypes = { width: PropTypes.number }